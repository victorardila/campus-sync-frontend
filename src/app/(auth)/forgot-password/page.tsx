...
const ForgotPassword = () => {
  const { resetPassword } = useAuth(); // Asegúrate de tener esta función en tu contexto
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await resetPassword({ username }); // Llama a la función para restablecer la contraseña
